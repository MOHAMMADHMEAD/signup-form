...
const AccountManagement = () => {
    ...
    return (
        <main className="max-w-sm	 mx-auto mt-8 flex flex-col gap-4 p-4 bg-white rounded-lg shadow-lg">
            <CardHeader title={'Accounts'} iconClass={'fa-user-circle'} subTitle={`If you have more than one account, you can add them and easily switch between.`}/>
            ...
            <div className="mb-4">
                ...
                <button type='button' onClick={()=>logout()} className="p-2 rounded-lg border flex flex-row items-center text-zinc-400 gap-2">
